                ...
                <div className="User-details">
                    <div>
                        <Typography style={{ fontSize: 18 }}>
                            ...
                            upload data, use this token to authenticate with the
                            API. For security purposes, this token is temporary,
                            and you will need to return to CIDC Portal to
                        ...
                        >
                            <Typography
                                ...
                                paragraph={true}
                            >
                                Your token represents your identity within the
                                CIDC System, so do not share it! Anyone who has
                                your token can perform actions as if they were
                                you.
                            </Typography>
